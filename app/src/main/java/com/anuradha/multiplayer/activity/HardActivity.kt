...
import com.anuradha.multiplayer.model.Cell
import com.anuradha.multiplayer.util.Board
import kotlinx.android.synthetic.main.activity_hard.*

class HardActivity : AppCompatActivity() {

    private
    val boardCells = Array(3) { arrayOfNulls<ImageView>(3) }
    ...
    inner class CellClickListener(
        ...
        override fun onClick(p0: View?) {
            ...
            if (!board.isGameOver) {
                ...
                /*val myRandomInt= Random.nextInt(5)
                if(myRandomInt<2) {
